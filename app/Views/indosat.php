...
<body>
  ...
  <div class="container py-5 mt-5">
    <h2 class="mb-4 fw-semibold text-white">Daftar Voucher Indosat</h2>
    <div class="row">

      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo indosat.png" alt="Logo indosat" class="logo-layanan mb-3" />
            <h5 class="card-title"> Indosat 6.000</h5>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo indosat.png" alt="Logo indosat" class="logo-layanan mb-3" />
            <h5 class="card-title">Indosat 10.000</h5>
            <p class="card-text">Kuota 5 GB, masa aktif 2 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo indosat.png" alt="Logo indosat" class="logo-layanan mb-3" />
            <h5 class="card-title">Indosat 14.000</h5>
            <p class="card-text">Kuota 2,5 + 0,5 GB, masa aktif 5 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo indosat.png" alt="Logo indosat" class="logo-layanan mb-3" />
            <h5 class="card-title">Indosat 15.500</h5>
            <p class="card-text">Kuota 3,5 + 0,5 GB, masa aktif 5 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo indosat.png" alt="Logo indosat" class="logo-layanan mb-3" />
            <h5 class="card-title">Indosat 20.000</h5>
            <p class="card-text">Kuota 5 + 2 GB, masa aktif 5 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo indosat.png" alt="Logo indosat" class="logo-layanan mb-3" />
            <h5 class="card-title">Indosat 25.000</h5>
            <p class="card-text">Kuota 7 + 2 GB, masa aktif 7 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo indosat.png" alt="Logo indosat" class="logo-layanan mb-3" />
            <h5 class="card-title">Indosat 22.000</h5>
            <p class="card-text">Kuota 3 + 1 GB, masa aktif 28 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
