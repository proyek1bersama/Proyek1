      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            ...
            <h5 class="card-title">Tri 25.000</h5>
            <p class="card-text">Kuota 2,5GB, masa aktif 90 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
       ...
       <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 3GB, masa aktif 1 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 3GB, masa aktif 3 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
       ...
       <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 3,5GB, masa aktif 90 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
       ...
       <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 4,5GB, masa aktif 5 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
       ...
       <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 5GB, masa aktif 2 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 6GB, masa aktif 3 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
       ...
       <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 6GB, masa aktif 5 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 6GB, masa aktif 90 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
       ...
       <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 7GB, masa aktif 28 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
       ...
       <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo tri.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">Tri 50.000</h5>
            <p class="card-text">Kuota 10GB, masa aktif 7 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div> -->
