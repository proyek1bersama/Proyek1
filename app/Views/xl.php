...
<!-- 
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 15.000</h5>
            <p class="card-text">Kuota 5 GB, masa aktif 5 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 20.000</h5>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 10.500</h5>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 12.000</h5>
            <p class="card-text">Kuota 3 GB, masa aktif 3 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 15.000</h5>
            <p class="card-text">Kuota 5 GB, masa aktif 3 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 14.000</h5>
            <p class="card-text">Kuota 2,5 GB, masa aktif 5 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 16.000</h5>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 19.000</h5>
            <p class="card-text">Kuota 6 GB, masa aktif 5 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 18.000</h5>
            <p class="card-text">Kuota 3,5 GB, masa aktif 7 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 22.000</h5>
            <p class="card-text">Kuota 5 GB, masa aktif 7 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 27.000</h5>
            <p class="card-text">Kuota 7 GB, masa aktif 7 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 22.000</h5>
            <p class="card-text">Kuota 3,5 GB, masa aktif 30 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 35.000</h5>
            <p class="card-text">Kuota 6,5 GB, masa aktif 30 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 48.000</h5>
            <p class="card-text">Kuota 9 GB, masa aktif 30 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card shadow-sm card-voucher h-100 text-center">
          <div class="card-body">
            <img src="images/logo xl.png" alt="Logo XL" class="logo-layanan mb-3" />
            <h5 class="card-title">XL Rp 69.000</h5>
            <p class="card-text">Kuota 15 GB, masa aktif 30 hari.</p>
            <a href="#" class="btn btn-tambah">Tambahkan ke keranjang</a>
          </div>
        </div>
      </div> -->
